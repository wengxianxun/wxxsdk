...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "joying"
  # s.authors            = { "joying" => "wengxianxun@hotmail.com" }
  # s.social_media_url   = "http://twitter.com/joying"
  ...
  s.source_files  = "wxxsdk", "wxxsdk/Classes/*"
  s.exclude_files = "wxxsdk/Exclude"
